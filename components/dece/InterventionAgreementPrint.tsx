...
interface InterventionAgreementPrintProps {
    intervention: Intervention;
    student: Student;
}

const InterventionAgreementPrint: React.FC<InterventionAgreementPrintProps> = ({ intervention, student }) => {
        ...
        <div className="bg-white p-8 font-serif text-gray-800">
            <header className="flex items-center justify-between border-b-2 border-gray-700 pb-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm">Departamento de Consejería Estudiantil (DECE)</p>
                    </div>
                </div>
            ...
            <main className="mt-8">
                ...
                <section className="space-y-4 text-base">
                    <p>En la fecha indicada, se lleva a cabo una reunión de tipo <strong>{intervention.type}</strong>, con el fin de abordar temas relacionados con el bienestar y desarrollo integral del/la estudiante:</p>
...
export default InterventionAgreementPrint;